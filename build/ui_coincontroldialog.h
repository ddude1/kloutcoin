...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 KLT"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 KLT"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 KLT"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 KLT"));
