...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Klout", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Klout</b> version", Q_NULLPTR));
...
"Copyright \302\251 2017 The Klout developers", Q_NULLPTR));
