...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelBalance->setText(QStringLiteral("0 KLT"));
        ...
        labelStake->setText(QStringLiteral("0 KLT"));
        ...
        labelUnconfirmed->setText(QStringLiteral("0 KLT"));
        ...
        labelImmature->setText(QStringLiteral("0 KLT"));
